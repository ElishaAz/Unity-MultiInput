...
{
    /// <summary>
    /// Each distinct button is associated with an event code. Whether it's a button on a keyboard
    /// or a button on a mouse, you'll probably be able to find it here. He is a helper enum class
    /// to make deciphering those codes easier.
    /// <br/>
