...
{
    /// <summary>
    /// Since the folder /dev/input is essentially an event bus of a bunch of input/output devices
    /// for the linux OS, there are a variety of event types that you may want to consume. Here is
    /// the enum that I was able to put together to make deciphering the event types a little easier.
    /// </summary>
